...
import cn.sanduo.mapper.UserMapperOutter;
...
public class TestMapperOuter {
	...
	/**
	 * 根据name模糊查询用户的个数---------有条件的查询
	 */
	@Test
	public void testFindUserCount() {
		SqlSession sqlSession = sqlSessionFactory.openSession();
		//获取代理创建代理对象
		UserMapperOutter mapper= sqlSession.getMapper(UserMapperOutter.class);
	 ...
	 */
	@Test
	public void testfindUserByIdResultIsHashMap() {
		SqlSession sqlSession = sqlSessionFactory.openSession();
		//获取代理创建代理对象
		UserMapperOutter mapper= sqlSession.getMapper(UserMapperOutter.class);
		
		User user = mapper.findUserByIdResultIsHashMap(1);
